...
import ShipSim from "./pages/projects/ShipSim";
import Intervo from "./pages/projects/Intervo";
    ...
    <Router>
      <div className={`main-container ${mode === "dark" ? "dark-mode" : "light-mode"}`}>
        ...
        <Routes>
          ...
          <Route path="/projects/smartcanteen" element={
            <>
              <ProjectsNavbar mode={mode} modeChange={handleModeChange} />
              <SmartCanteen />
            </>
          } />
           <Route path="/projects/shipsim" element={
            <>
              <ProjectsNavbar mode={mode} modeChange={handleModeChange} />
              <ShipSim />
            </>
          } />
          <Route path="/projects/intervo" element={
            <>
              <ProjectsNavbar mode={mode} modeChange={handleModeChange} />
              <Intervo />
            </>
