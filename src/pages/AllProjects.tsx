...
function AllProjects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      detailedPage: "/projects/SmartCanteen",
    },
    {
      id: 3,
      ...
      detailedPage: "/projects/ShipSim",
    },
    {
      id: 4,
      title: "Intervo",
      image: intervoScreenshot,
      description: "A context aware AI-powered voice interview platform designed to help you pratice for your interviews using the power of AI.",
      live: "https://intervo.duckdns.org",
      detailedPage: "/projects/Intervo",
    },
  ];
