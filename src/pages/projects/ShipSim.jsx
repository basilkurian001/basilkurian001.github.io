...
import { MdSpeed, MdOutlineFastfood, MdOutlineAdminPanelSettings, MdDownload } from "react-icons/md";
import { RiHandCoinLine } from "react-icons/ri";
import { IoIosTimer } from "react-icons/io";
import { GrSecure } from "react-icons/gr";
import { TbSettingsCheck } from "react-icons/tb";
import { BsLightningCharge } from "react-icons/bs";
import { FaShip, FaGear } from "react-icons/fa6";
...
const features = [
    {
        title: "Realistic Ship Physics",
        description: "Advanced ship movement mechanics with realistic buoyancy, drag, acceleration, and wave interaction to simulate authentic maritime navigation.",
        icon: <FaShip fontSize="large" />
    },
    {
        title: "Dynamic Environment Effects",
        description: "Implemented a responsive environment system featuring day and night effects, wave animations, and immersive environmental rendering.",
        icon: <GiWaveSurfer fontSize="large" />
    },
    {
        title: "Simulation Accuracy",
        description: "Focused on realistic controls, navigation systems, and responsive gameplay mechanics to deliver an engaging simulation experience.",
        icon: <FaGear fontSize={"large"} />
    },
    {
        title: "Sinking Animation",
        description: "Features a real time cutscene sinking animation of the RMS Titanic using Unity Timeline",
        icon: <GiSinkingShip fontSize={"large"} />
    },
];
                ...
                <Container maxWidth="lg">
                    ...
                    <Grid container spacing={8} alignItems="center" sx={{ mb: 12 }}>
                        <Grid item xs={12} md={6}>
                            <Box sx={{ mb: 2 }}>
                                <Chip
                                    label="Dive Into the Ultimate Maritime Experience"
                            ...
                            >
                                Ship Sim is a high-fidelity ship simulation project focused on delivering realistic maritime navigation, immersive ocean environments, 
                                and dynamic gameplay mechanics. The simulator combines advanced physics, and environmental effects to 
                                create an engaging and technically refined simulation experience.
                            </Typography>
                            ...
                            <Box sx={{ display: 'flex', gap: 2.5, flexWrap: 'wrap' }}>
                                <Button
                                    ...
                                    onClick={() => window.open("https://drive.google.com/drive/folders/1keq93P7pGIZYtpuOlPNcWmIrrlTaEOsl?usp=drive_link", "_blank")}
                                    sx={{
                                        borderWidth: '2px',
                                        borderColor: '#5000ca',
                                        color: '#5000ca',
