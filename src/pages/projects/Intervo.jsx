...
import { FaUserLock, FaBrain, FaShieldAlt, FaMicrophone } from "react-icons/fa";
...
const techStack = [
  "React", "Typescript", "Axios", "Node.js", "Express.js", "pg-promise", "NVIDIA Developer API", "PostgreSQL", "JWT", "Bcrypt", "AWS EC2", "NGINX", "Let's Encrypt", "PM2"
];

const features = [
  {
    title: "AI Voice Interviews",
    description: "Practice realistic interview conversations through an interactive voice-based AI interviewer.",
    icon: <AutoAwesomeIcon />
  },
  {
    title: "Detailed Interview Reports",
    description: "Receive personalized performance scores, feedback, and insights after completing an interview.",
    icon: <IoStatsChart fontSize="large" />
  },
  {
    title: "Interview History",
    description: "Keep track of previous interviews and review past conversations and performance.",
    icon: <MdHistory fontSize="large" />
  },
  {
    title: "Secure User Accounts",
    description: "Create a personal account and securely access your interview sessions and reports.",
    icon: <FaUserLock />
  }
];
...
const technicalHighlights = [
  {
    ...
    description: (
      <>
        Context-aware interview processing:
        <br />
        User Speech → AI Analysis → AI Response → Text-to-Speech
      </>
    ),
    icon: <FaBrain fontSize="large" />
  },
  {
    ...
    icon: <FaShieldAlt fontSize="large" />
  },
  {
    title: "Voice Conversation Pipeline",
    description: (
      <>
    ...
    icon: <FaMicrophone fontSize="large" />
  }
];
        ...
        <Container maxWidth="lg">
          ...
          <Grid container spacing={8} alignItems="center" sx={{ mb: 12 }}>
            <Grid item xs={12} md={6}>
              ...
              >
                Intervo is an AI-powered mock interview platform that helps candidates prepare for real-world interviews 
                through interactive voice conversations. Users can practice interviews tailored to their chosen role and difficulty, 
                receive natural AI-driven responses, and get detailed feedback and performance reports to identify areas for improvement.
              </Typography>
              ...
              <Box sx={{ display: 'flex', gap: 2.5, flexWrap: 'wrap' }}>
                <Button
                  ...
                  onClick={() => window.open("https://intervo.duckdns.org/", "_blank")}
                  sx={{
                    background: '#5000ca',
                    color: 'white',
                ...
                <Button
                  ...
                  className="action-btn"
                  onClick={() => window.open("https://github.com/basilkurian001/intervo", "_blank")}
                  sx={{
                    borderWidth: '2px',
                    borderColor: '#5000ca',
                    color: '#5000ca',
